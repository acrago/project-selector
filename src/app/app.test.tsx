...
describe('App tests', () => {
  ...
  // Layout/viewport-dependent: JSDOM doesn't render layout, so sidebar expansion and "Dashboard" link visibility
  // are not reliably testable here. Consider Cypress or similar for integration tests.
