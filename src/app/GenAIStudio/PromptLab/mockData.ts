...
export const mockPrompts: Prompt[] = [
  ...
  },
  {
    ...
    latestVersion: '1',
    lastModified: new Date('2025-11-01T10:00:00'),
    createdDate: new Date('2025-11-01T10:00:00'),
    ...
    versions: [
      {
        id: 'v11-1',
        versionNumber: '1',
        registeredAt: new Date('2025-11-01T10:00:00'),
        promptText: 'You are a helpful, harmless, and honest AI assistant. You answer questions accurately and concisely. If you are unsure about something, you say so rather than guessing. You format your responses clearly using appropriate structure.',
        promptType: 'text' as const,
        variables: [],
        aliases: ['helpful-assistant'],
        metadata: {},
        commitMessage: 'Initial global assistant prompt',
      },
    ],
  },
  {
    id: 'prompt-12',
    name: 'Code Expert',
    description: 'An expert coding assistant for software development tasks',
    latestVersion: '1',
    lastModified: new Date('2025-11-01T10:00:00'),
    createdDate: new Date('2025-11-01T10:00:00'),
    ...
    versions: [
      {
        ...
        versionNumber: '1',
        registeredAt: new Date('2025-11-01T10:00:00'),
        promptText: 'You are an expert software engineer proficient in {{ programming_language }}. Help the user with coding tasks including writing, reviewing, debugging, and optimizing code. Provide clear explanations, follow best practices, and include relevant code examples. When suggesting solutions, consider performance, readability, and maintainability.',
        promptType: 'text' as const,
        variables: ['programming_language'],
        aliases: ['code-expert'],
        metadata: {},
        commitMessage: 'Initial coding assistant prompt',
      },
    ],
  },
  {
    ...
    description: 'Professional customer service agent with empathy and problem-solving skills',
    latestVersion: '1',
    lastModified: new Date('2025-11-01T10:00:00'),
    createdDate: new Date('2025-11-01T10:00:00'),
    tags: ['customer-service', 'support', 'starter'],
    project: 'Global',
    versions: [
      {
        id: 'v13-1',
        versionNumber: '1',
        registeredAt: new Date('2025-11-01T10:00:00'),
        promptText: 'You are a professional customer service agent for {{ company_name }}. Greet the customer warmly, listen to their concerns, and provide helpful solutions. Show empathy, remain patient, and always aim for customer satisfaction. If you cannot resolve an issue, clearly explain the escalation process.',
        promptType: 'text' as const,
        variables: ['company_name'],
        aliases: ['cs-pro'],
        metadata: {},
        commitMessage: 'Initial customer service prompt',
      },
    ],
  },
];
